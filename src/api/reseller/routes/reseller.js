...
const permissions = [
  ...
  {
    api: "resellers",
    endpoint: "/api/resellers/customer-orders",
    method: "GET",
    handler: "Get Reseller Customer Orders",
  },
  {
    api: "resellers",
    endpoint: "/api/resellers/customers",
    method: "GET",
    handler: "Get Reseller Customers",
  },
  //   {
  //     api: "resellers",
...
export default (app) => {
  ...
  router.get("/customers", [RBAC], fetchResellerCustomers);
